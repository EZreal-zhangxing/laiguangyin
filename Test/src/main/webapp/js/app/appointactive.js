						...
						if (Data.outUrl) {
							...
							if(Data.haslike ==0)
							{
							  $(".wrap ul").append(
								...
								+"<img src='/readpicFile?filepath="+Data.articelPicPath+"'></a>"
								+"<p><a href='articontent.html?id="+Data.id+"'><i>"+Data.title+"</i></a>"
								   +"<span><b class='left'><i class='on'>"+Data.orderNum+"</i>/<i>"+Data.maxMannum+"</i></b>"
								         +"<b class='right dz'><i class='heart'>♡</i>"
								         +"<i class='dznum' data-haslike='"+Data.haslike+"' data-id='"+Data.id+"'>"+Data.likeNum+"</i></b>"
								   +"</span></p></li>");
							}else
							{
								...
								+"<p><a href='articontent.html?id="+Data.id+"'><i>"+Data.title+"</i></a>"
								   +"<span><b class='left'><i class='on'>"+Data.orderNum+"</i>/<i>"+Data.maxMannum+"</i></b>"
								         +"<b class='right dz on'><i class='heart on'>&#9829;</i>"
								         +"<i class='dznum' data-haslike='"+Data.haslike+"' data-id='"+Data.id+"'>"+Data.likeNum+"</i></b>"
								   +"</span></p></li>");
							}
...
//			 						$(dznum).parent().removeClass("on")
									...
									dznum.html(num);
			 						...
			 						//$(".right").addClass("on");
			 						//$(dznum).siblings().addClass("on");
//			 						$(dznum).addClass("on").siblings();
									$(dznum).addClass("on");
									hx.html("&#9829;");
			 						//点赞成功
									var num=dznum.html();
